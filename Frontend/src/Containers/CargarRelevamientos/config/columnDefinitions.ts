...
export const COLUMN_DEFINITIONS = [
  ...
  { id: "Rubro", title: "Rubro", width: 180, editable: true, group: "Relevamiento", icon: GridColumnIcon.HeaderString, cellType: "dropdown" },
  { id: "Contraproducencia", title: "Contraproducencia", width: 200, editable: true, group: "Relevamiento", icon: GridColumnIcon.HeaderString, cellType: "dropdown" },
];
