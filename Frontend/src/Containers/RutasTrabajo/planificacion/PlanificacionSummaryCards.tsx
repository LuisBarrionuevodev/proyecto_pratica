...
export type PlanificacionSummaryCardsProps = {
  ...
  /** Si true, los totales reflejan pins visibles en mapa (distrito + filtros panel). */

  usaDatasetVisible?: boolean;
 ...
 * Cards KPI interactivas: refinan lista y mapa sobre el dataset visible en mapa (STAB-10c-REWORK).
      ...
      {usaDatasetVisible ? (
        ...
        <Grid size={{ xs: 12 }}>
          ...
          >
            ...
            Indicadores calculados sobre direcciones visibles en mapa
