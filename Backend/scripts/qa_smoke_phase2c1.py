#!/usr/bin/env python
"""Smoke QA post FASE 2C.1 apply (read-only GETs)."""
...
def main() -> None:
    ...
    endpoints = [
        ...
        ("actuacion_detail", f"/actuaciones/{sample_act}"),
        ("ordenes_search", "/actuaciones/ordenes/search?q=1&limit=5"),
